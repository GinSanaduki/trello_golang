// trello_DeleteCard.go
// GOOS=windows GOARCH=amd64 go build -o trello_DeleteCard.exe trello_DeleteCard.go
// GOOS=linux GOARCH=amd64 go build -o trello_DeleteCard trello_DeleteCard.go
